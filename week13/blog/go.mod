...
require (
	...
	github.com/go-kratos/kratos/cmd/kratos/v2 v2.0.0-20210721045413-ab45baf5ec88 // indirect
	github.com/go-kratos/kratos/cmd/protoc-gen-go-errors/v2 v2.0.0-20210721045413-ab45baf5ec88 // indirect
	github.com/go-kratos/kratos/cmd/protoc-gen-go-http/v2 v2.0.0-20210721045413-ab45baf5ec88 // indirect
